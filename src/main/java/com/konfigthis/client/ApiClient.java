...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "http://api.rottentomatoes.com/api/public/v1.0";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("key", new ApiKeyAuth("query", "apikey"));
    ...
    public String getKey() {
        return ((ApiKeyAuth) this.getAuthentication("key")).getApiKey();
    }

    public void setKey(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("key")).setApiKey(apiKey);
    }

    public void setKeyPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("key")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.rottentomatoes.com/api/public/v1.0)
